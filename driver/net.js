...
(function() {
  var Connection, HttpConnection, Promise, TcpConnection, ar, aropt, cursors, err, events, mkAtom, mkErr, net, protoProtocol, protoQueryType, protoResponseType, protoVersion, protodef, r, tls, util, varar,
  ...
  Connection = (function(superClass) {
    ...
    Connection.prototype._processResponse = function(response, token) {
      var cb, cursor, feed, j, len, note, opts, profile, ref, ref1, root;
      profile = response.p;
